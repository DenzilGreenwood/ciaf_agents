...
def test_append_receipt():
    ...
    decision = PolicyDecision(
        allowed=True, requires_elevation=False, reason="Test decision"
    )
...
def test_verify_chain():
    ...
    for i in range(3):
        ...
        decision = PolicyDecision(allowed=True, requires_elevation=False, reason="Test")
...
def test_get_denied_receipts():
    ...
    for allowed in [True, False, True]:
        ...
        decision = PolicyDecision(
            allowed=allowed, requires_elevation=False, reason="Test"
        )
...
def test_verify_chain_with_valid_hash_invalid_prior_link():
    ...
    decision1 = PolicyDecision(allowed=True, requires_elevation=False, reason="Test")
    ...
    signature2 = sign_receipt(
        {**payload2, "receipt_hash": receipt_hash2}, "test-secret"
    )

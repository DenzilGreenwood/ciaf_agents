...
def any_condition(
    identity: Identity, resource: Resource, params: Dict[str, Any]
) -> bool:
    """
...
def same_department_only(
    ...
    """
    return identity.attributes.get("department") == resource.attributes.get(
        "department"
    )


def production_environment_only(
    identity: Identity, resource: Resource, params: Dict[str, Any]
) -> bool:
    """
